...
#include "f_user.h"
#include "f_util.h"
gboolean CreateGroup_cb(struct fetion_account_data *sip, struct sipmsg *msg,
			struct transaction *tc);
void fetion_add_group(PurpleConnection * gc, const gchar * who,
		      const gchar * old_group, const gchar * new_group);
void fetion_change_group(PurpleConnection * gc, const char *who,
