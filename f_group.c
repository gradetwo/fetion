...
gboolean
CreateGroup_cb(struct fetion_account_data *sip, struct sipmsg *msg,
...
void
fetion_add_group(PurpleConnection * gc, const gchar * who,
...
void
fetion_change_group(PurpleConnection * gc, const char *who,
...
void
fetion_rename_group(PurpleConnection * gc, const gchar * old_name,
